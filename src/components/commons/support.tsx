...
export default function Support() {
    ...
    return (
        <motion.div className='p-2 bg-gray-200 py-[30px]' variants={fadeIn}>
            <motion.aside className='flex gap-[10px] items-start flex-col text-start ml-[40px] pt-[40px]'  variants={{
                            hidden: { opacity: 0 },
                            visible: {
                                opacity: 1,
                                transition: {
                ...
                <main className=''>
                    <motion.h4
                        variants={fadeIn}
                        style={{ fontFamily: 'Admiral, cursive' }}
                        className='pb-[20px]' >
            ...
            <main className="flex flex-col justify-center items-center ">
                <h4 style={{ fontFamily: 'Admiral, cursive' }} >What we offer</h4>
